...
<img class="alignnone size-full wp-image-620" alt="Chef2-BandeauChefVim" src="{{ site.url }}/images/2013/04/Chef2-BandeauChefVim.png" width="849" height="66" srcset="{{ site.url }}/images/2013/04/Chef2-BandeauChefVim-300x23.png 300w, {{ site.url }}/images/2013/04/Chef2-BandeauChefVim.png 849w" sizes="(max-width: 849px) 100vw, 849px" />

Parce que pour un bon Chef, le plus important c&rsquo;est un bon poste de travail !

<em id="__mceDel"><!--more-->

<em id="__mceDel">A commencer par :</em><br /> <a href="2013/04/Chef2-Hote.jpeg"><img class="size-full wp-image-624 alignnone" alt="Une Hote" src="{{ site.url }}/images/2013/04/Chef2-Hote.jpeg" width="300" height="152" /></a>

<em id="__mceDel"><em id="__mceDel">Bon, plus sérieusement, vous verrez souvent ce schéma dans les présentations Chef :</em></em>

<em id="__mceDel"><a href="2013/04/overview_chef_draft.png"><img alt="Architecture Chef" src="{{ site.url }}/images/2013/04/overview_chef_draft.png" width="600" height="560" /></a></em>
...
[<img class="alignnone size-full wp-image-635" alt="Génération de la configuration de knife" src="{{ site.url }}/images/2013/04/Chef2-generate-knife-config.png" width="605" height="283" srcset="{{ site.url }}/images/2013/04/Chef2-generate-knife-config-300x140.png 300w, {{ site.url }}/images/2013/04/Chef2-generate-knife-config.png 605w" sizes="(max-width: 605px) 100vw, 605px" />][4]

Préparez la clé de validation :  
[<img class="alignnone size-full wp-image-639" alt="Génération de la clé de validation" src="{{ site.url }}/images/2013/04/Chef2-generate-validator-key.png" width="605" height="283" srcset="{{ site.url }}/images/2013/04/Chef2-generate-validator-key-300x140.png 300w, {{ site.url }}/images/2013/04/Chef2-generate-validator-key.png 605w" sizes="(max-width: 605px) 100vw, 605px" />][5]
...
Vous constatez que c&rsquo;est la même chose que dans l&rsquo;IHM Web <img src="{{ site.url }}/images/smilies/simple-smile.png" alt=":)" class="wp-smiley" style="height: 1em; max-height: 1em;" />
...
[<img class="alignnone size-full wp-image-643" alt="Régénérer sa clé utilisateur" src="{{ site.url }}/images/2013/04/Chef2-reset-user-key.png" width="520" height="248" srcset="{{ site.url }}/images/2013/04/Chef2-reset-user-key-300x143.png 300w, {{ site.url }}/images/2013/04/Chef2-reset-user-key.png 520w" sizes="(max-width: 520px) 100vw, 520px" />][7]

Voila voila, si tout ça marche pour vous c&rsquo;est bon pour les articles à suivre. Sinon il va falloir trouver pourquoi <img src="{{ site.url }}/images/smilies/simple-smile.png" alt=":)" class="wp-smiley" style="height: 1em; max-height: 1em;" />
...
[La suite chef !][12]
 ...
 [12]: {{ site.url }}/divers/chef-3-tdd-1/ "Utiliser Chef #3 – TDD ! 1/2"
